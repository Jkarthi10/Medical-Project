...
<body bgcolor="#ADD8E6">
  ...
  <section class="home-section">
	...
	<%@page import="java.sql.*" %>
 		...
 		%> 
 	<form action="ordermed" method="POST" name="contact-form" enctype="multipart/form-data"> 
	<div class="reg">
	
	<table>
		<tr><td>Pharmacy Name:</td><td><input type="text" readonly="readonly" value="<%=name%>" name="pname"  required="required"></td></tr>
		<tr><td>Pharmacy Id:</td><td><input type="number" readonly="readonly" value="<%=id%>" name="id"  required="required"></td></tr>
        <tr><td>Name:</td><td><input type="text"  name="name"  required="required"></td></tr>
		<tr><td>Email: </td><td><input type="text" readonly="readonly"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" name="email" value="<%=email%>"></td></tr>
        <tr><td>Contact: </td><td><input type="text" pattern="^\d{10}$" name="contact" placeholder="contact number" required></td></tr>
        <tr><td>Address:</td><td><textarea rows="4" cols="40" name="address" required></textarea></td></tr>
        <tr><td>Drug:</td><td><textarea rows="4" cols="40" name="drug" required></textarea></td></tr>
        <tr><td>Upload Prescription: </td><td><input type="file" name="image" required></td></tr>
