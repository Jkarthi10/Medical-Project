...
.css-serial tr.active-row{
  ...
  color: #009879;
    ...
    <tr><th>S.no</th><th>Lab Center Name</th><th>Lab address</th><th>Patient name</th><th>Type of Test</th><th>View Result</th></tr>
<%
     String email =  (String) session.getAttribute("email");
     Class.forName("com.mysql.jdbc.Driver");
     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/medical","root","karthi");
     PreparedStatement ps=con.prepareStatement("select * from labreport where email=?");
   ...
   <td>
     ...
     <td>
    <a href="downloadreport.jsp?id=<%=rs.getString(1)%>">View Result</a>
    </td>
