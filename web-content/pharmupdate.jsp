	...
	<%@page import="java.sql.*" %>
 		<% 
            ...
            PreparedStatement ps=con.prepareStatement("select * from pharmacy where email='"+e+"'");
 			...
 			while(rs.next()){
 		%> 
 	<form action="pharmupserver.jsp " method="get">		
	<div class="reg">
	
	<table>
		<tr><td></td></tr>
		<tr><td>Name</td><td><input  type="text" value="<%=rs.getString("pharmname")%>" name="pharmname" placeholder="Full Name" required="required"></td></tr>
