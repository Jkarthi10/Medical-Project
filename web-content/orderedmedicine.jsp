...
.css-serial tr.active-row{
  ...
  color: #009879;
    ...
    <tr><th>S.no</th><th>Pharmacy Id</th><th>Pharmacy Name</th><th>User Name</th><th>Email</th><th>Contact</th><th>Address</th><th>Drug</th><th>View Prescription</th><th>Cancel Medicine</th></tr>
<%
     String email =  (String) session.getAttribute("email");
     Class.forName("com.mysql.jdbc.Driver");
     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/medical","root","karthi");
     PreparedStatement ps=con.prepareStatement("select * from ordermed where email=?");
   ...
   <td>
    ...
    <%=rs.getString(8)%>
     ...
     <td>
    <a href="prescription.jsp?id=<%=rs.getString(1)%>">View Prescription</a>
    </td>
    <td>
