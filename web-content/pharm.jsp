...
<html lang="en" dir="ltr">
  ...
  <script>
    function sendotp(){
         ...
         if((email!="")&&(text!="")){
         var url = "pharmregotp.jsp?val="+text+"&email="+email;  
   ...
   <script>
    ...
    function checkcontact(){
          ...
          var text= document.getElementById("contact").value;
          var url = "checkpharmcon.jsp?val="+text;
   ...
   <script>
    ...
    function find(){          
          ...
          var url = "pharmemailval.jsp?val="+text;
...
<body>
  <div class="container" >
    <div class="title">Pharmacy Registration</div>
    <div class="content">
      <form action="pharmreg.jsp" method="post" name="register" id="register">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Pharmacy Name</span>
            <input type="text" placeholder="Enter your hospital name" name="pharmname" id="name" required>
          </div>
          <div class="input-box">
