...
<script>
  ...
  <section class="home-section">
	...
	<table>
		<tr><td></td></tr>
		<tr><td>Lab Id:</td><td><input  readonly="readonly" value="<%=rs.getString("id")%>" name="name"  required="required"></td></tr>
		<tr><td>Admin:</td><td><input  readonly="readonly" value="<%=rs.getString("admin")%>" name="name"  required="required"></td></tr>
		<tr><td>Lab Name:</td><td><input readonly="readonly" value="<%=rs.getString("labname")%>" name="dob" required="required"></td></tr>
		<tr><td>Email Id:</td><td><input readonly="readonly" value="<%=rs.getString("email")%>" name="email" placeholder="xyz@gmail.com" ></td></tr>
		<tr><td>Password :</td><td><input type="password" readonly="readonly" type="password" value="<%=rs.getString("password")%>" name="password"  required="required" id="mypassword" ></td></tr>
		<tr><td>Contact No:</td><td><input readonly="readonly" value="<%=rs.getString("contact")%>"  name="contact"  required="required"></td></tr>
		<tr><td>Address:</td><td><input readonly="readonly" value="<%=rs.getString("address")%>" name="dob" required="required"></td></tr>
		<tr><td>Pincode:</td><td><input readonly="readonly" value="<%=rs.getString("pincode")%>" name="pincode" required="required"></td></tr>
		<tr><td>Home Blood Sample Collection:</td><td><input readonly="readonly" value="<%=rs.getString("homesample")%>"  name="contact"  required="required"></td></tr>
