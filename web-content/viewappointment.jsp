...
try{
    ...
    <tr><th>S.no</th><th>Patient Name</th><th>address</th><th>contact</th><th>email</th><th>timeslot</th><th>Name of test</th><th>Cancel Appointment</th></tr>
<%
     String admin =  (String) session.getAttribute("admin");
   
     Class.forName("com.mysql.jdbc.Driver");
     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/medical","root","karthi");
     PreparedStatement ps=con.prepareStatement("select * from labappointment where admin=?");
   ...
   <td>
    ...
    <td>
    <a href="cancelapp.jsp?id=<%=rs.getString(1)%>">cancel</a>
    </td>
    </tr>
   <%
    }
