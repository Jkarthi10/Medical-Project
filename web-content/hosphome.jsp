...
<body bgcolor="#ADD8E6">
  ...
  <section class="home-section">
	...
	<table>
		...
		<tr><td>Hospital Name:</td><td><input  readonly="readonly" value="<%=rs.getString("hospname")%>" name="hospname"  required="required"></td></tr>
        ...
        <tr><td>City:</td><td><input readonly="readonly" value="<%=rs.getString("city")%>" name="city" required="required"></td></tr>
		...
		<tr><td>Speciality:</td><td><input readonly="readonly" value="<%=rs.getString("speciality")%>" name="speciality" placeholder="speciality" ></td></tr>
